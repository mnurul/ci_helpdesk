<?= $this->extend('v_all_ticket_a/template'); ?>
                ...
                <div style="margin-top:15px; ">
                    ...
                    <div class="card bg-card mt-3 mb-5">
                        <div class="card-body">
                            ...
                            ?>
                            <div class="row">
                                <?php foreach ($v_all_ticket_a as $t) : ?>
                                    <div class="column">
                                        <div class="card">
                            ...
                            <?= $pager->links('v_all_ticket_a', 'user_pagination') ?>
                            <a href="<?= base_url(); ?>/admin/v_all_ticket_a" title="Back to view all data">
