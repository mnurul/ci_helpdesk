...
?>
<?= $this->extend('create_word/template'); ?>
    ...
    <div class="row">
        <div class="col">
            ...
            <div style="padding-left:30px;margin-top:15px; ">
                <h2 class="title font-weight-bold">Create Word</h2>
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-75">
                                    <input type="text" class="auto-save form-control" id="word" name="word" required value="<?= $word; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                    <label class="title-1" for="correctword">Correct Word</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" id="correctword" name="correctword" class="auto-save form-control" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-75">
