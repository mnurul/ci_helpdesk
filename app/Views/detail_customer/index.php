            ...
            <div style="padding-left:30px;margin-top:15px; ">
                ...
                <div class="card mt-3 mb-5">
                    <div class="card-body">
                        ...
                        <?php }
                        ?>
                        <form action="/admin/edit_customer/<?= $customer['idcustomer']; ?>" method="post">
                            <div class="row">
                                <div class="col-25">
                                    <label class="title-1" for="idcustomer">Id Customer</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" id="idcustomer" name="idcustomer" autofocus value="<?= (old('idcustomer')) ? old('idcustomer') : $customer['idcustomer']; ?>" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                ...
                                <div class="col-75">
                                    <input type="text" id="csnama" name="csnama" value="<?= (old('csnama')) ? old('csnama') : $customer['csnama']; ?>">
                                </div>
                            </div>
                            <!-- <div class="row">
                                <div class="col-25">
                            ...
                            <div class="row">
                                ...
                                <div class="col-75">
                                    <textarea id="alamat" name="alamat" style="height:200px" value="<?= (old('alamat')) ? old('alamat') : $customer['alamat']; ?>"><?= $customer['alamat']; ?></textarea> </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                ...
                                <div class="col-75">
                                    <input type="text" id="telp" name="telp" value="<?= (old('telp')) ? old('telp') : $customer['telp']; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                ...
                                <div class="col-75">
                                    <input type="email" id="email" name="email" value="<?= (old('email')) ? old('email') : $customer['email']; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                ...
                                <div class="col-75">
                                    <input type="text" id="pic" name="pic" value="<?= (old('pic')) ? old('pic') : $customer['pic']; ?>" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                ...
                                <div class="col-75">
                                    <input type="text" id="csproduct" name="csproduct" value="<?= (old('csproduct')) ? old('csproduct') : $customer['csproduct']; ?>" required>
                                </div>
                            </div>
                                ...
                                <div class="col-75">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <!-- <a href="/admin/edit_user/<?= $customer['idcustomer']; ?>" class="btn btn-edit">Edit</a> -->
                                        </div>
                                        <div class="col">
                                            <!-- <form action="/admin/delete/<?= $customer['idcustomer']; ?>" method="POST" class="d-inline">
                                                <?= csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-75">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <form action="/customer/<?= $customer['idcustomer']; ?>" method="post" class="d-inline">
