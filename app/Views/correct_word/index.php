<?= $this->extend('correct_word/template'); ?>
        ...
        <div class="row">
            <div class="col">
                ...
                <div style="margin-top:15px; ">
                    <h2 class="title font-weight-bold">Correct Word</h2>
                    <div class="card bg-card mt-3 mb-5">
                        <div class="card-body">
                            <a href="<?= base_url(); ?>/admin/create_word" class="a-user ">Add Word</a>
                            ...
                            <div class="row">
                                ...
                                <?php $no = 0; ?>
                                <?php foreach ($correctword as $u) : ?>
                                    <div class="column">
                                        <div class="card">
                                            <div class="row no-gutters">
                                                <div class="col-6">
                                                    <h6 class="card-subtitle st-ticket text-muted"><?= $u['id']; ?></h6>
                                                </div>
                                                <div class="col-6">
                                                    <h6 class="card-subtitle mb-2 st-date text-muted"><?= $u['word']; ?></h6>
                                                </div>
                                            </div>
                                            <hr style="margin-top: 10px;">
                                            <h5 class="card-title text"><?= $u['correctword']; ?></h5>
                                            <a href="<?= base_url(); ?>/admin/detail_word/<?= $u['id']; ?>" class=" btn-assign">Detail</a>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                                <!-- <div class="column">
                            ...
                            <?= $pager->links('correctword', 'user_pagination') ?>
                            <a href="<?= base_url(); ?>/admin/correct_word" title="Back to view all data">
