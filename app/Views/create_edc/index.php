...
?>
<?= $this->extend('create_edc/template'); ?>
    ...
    <div class="row">
        <div class="col">
            ...
            <div style="padding-left:30px;margin-top:15px; ">
                <h2 class="title font-weight-bold">Create EDC</h2>
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            <div class="row">
                                ...
                                <div class="col-75">
                                    <input type="text" id="jedc" name="jedc" required value="<?= $jenisedc; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                ...
                                <div class="col-75">
                                    <input type="text" id="lokasi" name="lokasi" required value="<?= $lokasi; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                            ...
                            <div class="row">
                                ...
                                <div class="col-75">
                                    <input type="text" id="pertanyaan" name="pertanyaan" required value="<?= $pertanyaan; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
