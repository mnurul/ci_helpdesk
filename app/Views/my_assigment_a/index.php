                ...
                <div style="margin-top:15px; ">
                    ...
                    <div class="card bg-card mt-3 mb-5">
                        <div class="card-body">
                                    ...
                                    <div class="column">
                                        <div class="card">
                                            <div class="row no-gutters">
                                                <div class="col-6">
                                                    <h6 class="card-subtitle st-ticket text-muted"><?= $w['csnama']; ?></h6>
                                                </div>
                                                <div class="col-6">
                                            ...
                                            <div class="btn-assign" datahover="test" title="<?= ($w['status'] == 'Assigned' ? 'Ticket ini udah kamu Assigned'   : null) ?>">
                                                <a href="<?= base_url(); ?>/admin/detail_assigment_a/<?= $w['id']; ?>" title="<?= ($w['status'] == 'Assigned' ? 'Non1'   : null) ?>" class="a-assign <?= ($w['status'] == 'Assigned' ? 'disable'   : null) ?>">Assign</a>
                                            </div>
                            ...
                            <a href="<?= base_url(); ?>/admin/my_assigment_a" title="Back to view all data">
