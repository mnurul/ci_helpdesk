<?= $this->extend('detail_vocabs/template'); ?>
    ...
    <div class="row">
        <div class="col">
            ...
            <div style="padding-left:30px;margin-top:15px; ">
                <h2 class="title font-weight-bold">Detail Vocabs</h2>
                <div class="card mt-3 mb-5">
                    <div class="card-body">
                        ...
                        <?php }
                        ?>
                        <form action="/admin/edit_vocabs/<?= $vocabs['idvocab']; ?>" method="post">
                            <div class="row">
                                <div class="col-25">
                                    <label class="title-1" for="idvocab">Id Vocabs</label>
                                </div>
                                <div class="col-75">
                            ...
                            <div class="row">
                                ...
                                <div class="col-75">
                                    <input type="text" id="ask" name="ask" value="<?= (old('ask')) ? old('ask') : $vocabs['ask']; ?>" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                ...
                                <div class="col-75">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <!-- <a href="/admin/edit_user/<?= $vocabs['idvocab']; ?>" class="btn btn-edit">Edit</a> -->
                                        </div>
                                        <div class="col">
                                            <!-- <form action="/admin/delete/<?= $vocabs['idvocab']; ?>" method="POST" class="d-inline">
                                                <?= csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-75">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <form action="/vocabs/<?= $vocabs['idvocab']; ?>" method="post" class="d-inline">
