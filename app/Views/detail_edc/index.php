<?= $this->extend('detail_edc/template'); ?>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="topnav" id="myTopnav">
                ...
                <a href="<?= base_url(); ?>/admin/edc">Back</a>
            ...
            <div style="padding-left:30px;margin-top:15px; ">
                <h2 class="title font-weight-bold">Detail EDC</h2>
                <div class="card mt-3 mb-5">
                    <div class="card-body">
                        ...
                        <?php }
                        ?>
                        <form action="/admin/edit_edc/<?= $edc['id']; ?>" method="post">
                            <div class="row">
                                <div class="col-25">
                                    <label class="title-1" for="id">Id</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" id="id" name="id" autofocus value="<?= (old('id')) ? old('id') : $edc['id']; ?>" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                    <label class="title-1" for="jedc">Jenis Edc</label>
                                </div>
                                <div class="col-75">
                                    <input type="text" id="jedc" name="jedc" value="<?= (old('jedc')) ? old('jedc') : $edc['jenisedc']; ?>" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                ...
                                <div class="col-75">
                                    <input type="text" id="lokasi" name="lokasi" value="<?= (old('lokasi')) ? old('lokasi') : $edc['lokasi']; ?>" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                ...
                                <div class="col-75">
                                    <input type="text" id="pic" name="pic" value="<?= (old('pic')) ? old('pic') : $edc['pic']; ?>" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                ...
                                <div class="col-75">
                                    <input type="text" id="pertanyaan" name="pertanyaan" value="<?= (old('pertanyaan')) ? old('pertanyaan') : $edc['pertanyaan']; ?>" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                ...
                                <div class="col-75">
                                    <input type="text" id="idcustomer" name="idcustomer" value="<?= (old('idcustomer')) ? old('idcustomer') : $edc['idcustomer']; ?>" required>
                                </div>
                            </div>
                                ...
                                <div class="col-75">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <!-- <a href="/admin/edit_user/<?= $edc['id']; ?>" class="btn btn-edit">Edit</a> -->
                                        </div>
                                        <div class="col">
                                            <!-- <form action="/admin/delete/<?= $edc['id']; ?>" method="POST" class="d-inline">
                                                <?= csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-75">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <form action="/edc/<?= $edc['id']; ?>" method="post" class="d-inline">
